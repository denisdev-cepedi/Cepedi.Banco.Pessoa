...
public class AtualizarTelefoneRequestValidation : AbstractValidator<AtualizarTelefoneRequest>
{
    public AtualizarTelefoneRequestValidation()
    {
        ...
        RuleFor(telefone => telefone.Principal).Must(x => x == false || x == true).WithMessage("Deve ser informado se é o telefone principal");
